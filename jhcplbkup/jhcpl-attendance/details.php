...
$sql = "SELECT id, name, unit_no, age, sex, mobile, designation, date, salary,leaves_allowed, leaves_taken, deductions,salary_final, notes FROM attendance_record WHERE id = '$id'";
...
if ($result->num_rows > 0) {
  ...
  <table>
  <tr><th>Leaves Allowed</th><td><input type='text' name='leaves_allowed' value='".$row["leaves_allowed"]."'></td></tr>
  <tr><td colspan='2'> </td></tr>

  <tr><th>Leaves Taken</th><td><input type='text' name='leaves_taken' value='".$row["leaves_taken"]."'></td></tr>
  <tr><td colspan='2'> </td></tr>


  <tr><th>Deductions</th><td><input type='text' name='deductions' value='".$row["deductions"]."'></td></tr>
  <tr><td colspan='2'> </td></tr>
  <tr><th>Salary Final</th><td><input type='text' name='salary_final' value='".$row["salary_final"]."'>
  </td></tr>
  <tr><td colspan='2'> </td></tr>

...
if (isset($_POST['submit'])) {
  ...
  //$name = $_POST['name'];//name added later
  ...
  if ($result->num_rows > 0) {
    ...
    echo "<h2>Add New Consultation Visit for unit_no: $unit_no </h2>
...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO visits (unit_no, age, sex, diagnosis, date) VALUES ('$unit_no', '$age', '$sex', '$diagnosis', '$date')";
    if ($conn->query($sql) === TRUE) {
        echo "New Consultation Record Of Unit No: $unit_no, Name: $name On $date created successfully";
        header('location: visitsAddEdit.php');
    } else {

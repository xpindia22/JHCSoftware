...
<html>
<head>
    <title>Sort Employee Info</title>
    <style>
        body {
...
if ($result->num_rows > 0) {
    ...
    echo "<tr><th>ID</th><th>Name</th><th>Age</th><th>Sex</th><th>Unit No</th><th>Designation</th><th>Date</th><th>Mobile</th><th>Address</th><th>Notes<th>Salary</th><th>Overtime</th><th>Leaves</th><th>Deductions</th><th>final_salary</th><th>Total</th></tr>";

    while ($row = $result->fetch_assoc()) {
        // Calculate row-wise total
        $row_total = $row['salary']  + $row['leaves_allowed'] ;

        // Add to grand totals
        $grand_total_salary += $row['salary'];
        //$grand_total_leaves_allowed += $row['leaves_allowed'];
        ...
        echo "<td style='border: 1px solid black;'>" . $row['designation'] . "</td>";
        ...
        echo "<td style='border: 1px solid black;'>" . $row['leaves_allowed'] . "</td>";
    ...
    echo "<td style='border: 1px solid black;'>" . $grand_total_salary . "</td>";
     
    //echo "<td style='border: 1px solid black;'>" . $grand_total_leaves_allowed . "</td>";

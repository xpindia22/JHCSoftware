...
body{
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tr><th>ID</th><th>Name</th><th>Age</th><th>Sex</th><th>Unit No</th><th>Diagnosis</th>
        
        <th>Date</th><th>Mobile</th><th>Address</th><th>Notes<th>Consultation</th><th>ECG</th><th>ECHO</th><th>MEDICINES</th><th>LAB</th><th>Total</th></tr>";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo " <td style='border: 1px solid black;'><a href='004_new-revisit.php?id=".$row["unit_no"]."'>".$row["unit_no"]."</a></td>";

...
if (isset($_POST['submit'])) {
  ...
  $sql = "SELECT name, age, sex, mobile, designation, salary,leaves_allowed , notes FROM attendance WHERE unit_no = '$unit_no'";
  $result = $conn->query($sql);
...
<table class='table'> <form method='post' action=''>
  ...
  <td><input type='number' id='salary_final' name='salary_final' value='0'></td>
    ...
    <td><input type='text' id='notes' name='notes' value='0'></td>
    </tr>
    <tr>

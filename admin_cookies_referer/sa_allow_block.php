<?php
session_start();
require_once 'conn.php'; // Ensure this path is correct for your project

// List of users to be granted Super Admin rights (comma separated)
$super_admin_users = ['user1', 'user2', 'user3']; // Replace with actual usernames

// List of users blocked from Super Admin rights (comma separated)
$blocked_users = ['blocked_user1', 'blocked_user2']; // Replace with actual usernames

// Check if the logged-in user is blocked
if (in_array($_SESSION['username'], $blocked_users)) {
    echo "Access denied. You are blocked from being granted Super Admin rights.";
    exit;
}

// Check if the logged-in user is in the list of Super Admin users
if (!in_array($_SESSION['username'], $super_admin_users)) {
...
<body>
    ...
    <form method="post" action="">
        ...
        <input type="checkbox" name="roles[]" value="Finance"> Finance<br>
        <input type="checkbox" name="roles[]" value="SA"> Super Admin<br><br>
